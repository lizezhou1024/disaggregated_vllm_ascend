...
from vllm.distributed import (ensure_model_parallel_initialized,
                              ...
                              init_distributed_environment_fake,
                              ensure_kv_transfer_initialized,
                              init_kv_transfer_environment,
...
class NPUWorker(LocalOrDistributedWorkerBase):
    ...
    def __init__(
        ...
        self.vllm_config.device_config.device = torch.device(f"npu:{self.local_rank}")
    ...
    def init_device(self) -> None:
        if self.device_config.device.type == "npu":
            ...
            import os
            print("in worker init_device:",self.device, os.getenv('ASCEND_RT_VISIBLE_DEVICES'))
            NPUPlatform.set_device(self.device)
    ...
    def _init_worker_distributed_environment(
        ...
        # First create kv transfer group, and then init distributed environment
        init_kv_transfer_environment(self.vllm_config, parallel_config.world_size, rank, local_rank, backend)

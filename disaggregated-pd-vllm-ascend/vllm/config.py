...
class KVTransferConfig(BaseModel):
    ...
    # Whether this vLLM instance produces, consumes KV cache.
    # Choices are 'kv_producer' and 'kv_consumer'.
    ...
    # The world size of the peer
    peer_world_size: int = 1

    # The KV parallel size of the peer
    peer_kv_parallel_size: int = 1

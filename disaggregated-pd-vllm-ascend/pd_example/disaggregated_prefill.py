...
def run_prefill(prefill_done = None):
    ...
    ##    '{"kv_connector":"HcclConnector","kv_role":"kv_consumer","kv_rank":1,"kv_parallel_size":2}'
    ##)
    ktc = KVTransferConfig.from_cli(
...
def run_decode(prefill_done = None):
    ...
    print("Decode node is prepared.")

    # Wait for the producer to start the pipe
    # if prefill_done is not None:
    #     print("Waiting for prefill node to finish...")
    #     prefill_done.wait()
    #     print("Prefill node finished.")
